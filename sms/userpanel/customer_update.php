            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-3 bg-light p-0 m-0">
                        <h4 class="bg-success text-white p-2">Order</h4>
                        <ul class="list-group mx-4 mb-4">
                            <li class="list-group-item"><a href="order_product.php" class="text-primary text-decoration-none">Take Order</a></li>
                        </ul>
                        <h4 class="bg-success text-white p-2">Report</h4>
                        <ul class="list-group mx-4 mb-4">
                            <li class="list-group-item"><a href="order_product_list.php" class="text-primary text-decoration-none">Order List</a></li>
                        </ul>
                        <h4 class="bg-success text-white p-2">Profile</h4>
                        <ul class="list-group mx-4 mb-4">
                            <li class="list-group-item"><a href="customer_update.php" class="text-primary text-decoration-none">Update Profile</a></li>
                        </ul>
                    </div>
                    <div class="col-sm-9 border-start border-success">
                        ...
                        <div class="container p-4 m-4">
                            ...
                            if (isset($_GET['customer_name'])) {
                                ...
                                $new_customer_password  =  $_GET['customer_password'];
